...
function NotFoundPage() {
  return (
    <div
      ...
      dir="rtl"
    >
      <PageTitle title="404 - דף לא נמצא - מאפיית מרציפן" />
      <div className="max-w-2xl w-full bg-white/80 backdrop-blur-xl p-10 md:p-16 rounded-[3.5rem] shadow-2xl border border-[#D4AF37]/20 relative z-10 transition-all hover:shadow-[0_20px_60px_rgba(212,175,55,0.15)] duration-500">
        ...
        <header>
          <h1 className="text-3xl md:text-5xl font-black text-[#2D211E] mb-6 leading-tight">
            אופס! נראה שחיסלו את <br />
            <span className="text-[#B91C1C]">כל הפירורים...</span>
          </h1>
          {/* קו הפרדה מעוצב */}
        ...
        <p className="text-xl text-gray-600 mb-12 leading-relaxed font-light max-w-md mx-auto">
          הדף שחיפשתם כנראה נאפה יותר מדי או שפשוט לא קיים. אל דאגה, יש לנו עוד
          המון מאפים טריים שמחכים לכם!
        </p>
